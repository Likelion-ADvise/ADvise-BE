...
urlpatterns = [
    ...
    path('ads/<int:ad_id>/', create_proposal, name='create_proposal'), #댓글 작성
    path('ads/<int:ad_id>/<int:pk>/delete/', delete_proposal, name='delete_proposal'), #댓글 삭제
    path('ads/<int:pk>/', get_ad, name='get_ad'), #특정 게시물 검색
